...
from app.gui.audio_view import AudioView
from app.gui.model_view import ModelView
from app.gui.training_view import TrainingView
...
class RepeatApp(App):
    ...
    def __init__(self, audio_manager, model_manager, training_manager, **kwargs):
    ...
    def build(self):
        ...
        layout = SparseGridLayout(rows=1, cols=3)
        ...
        layout.add_entry(TrainingView(self.audio_manager, self.model_manager, self.training_manager), position=(0, 2), shape=(1, 1))
